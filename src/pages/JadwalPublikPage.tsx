        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Link to="/">
                <Button variant="ghost" size="sm" className="text-primary-foreground/70 hover:text-primary-foreground hover:bg-primary-foreground/10 gap-1">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold leading-tight">Jadwal Pelajaran</h1>
                <p className="text-xs opacity-80">e-Jadwal MTsN 5 Jakarta</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
...
export default JadwalPublikPage;
